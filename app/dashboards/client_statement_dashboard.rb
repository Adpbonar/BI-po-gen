...
class ClientStatementDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how client statements are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(client_statement)
  #   "ClientStatement ##{client_statement.id}"
  # end
end
