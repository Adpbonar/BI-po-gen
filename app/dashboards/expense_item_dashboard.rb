...
class ExpenseItemDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how expense items are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(expense_item)
  #   "ExpenseItem ##{expense_item.id}"
  # end
end
