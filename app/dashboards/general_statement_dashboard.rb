...
class GeneralStatementDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how general statements are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(general_statement)
  #   "GeneralStatement ##{general_statement.id}"
  # end
end
