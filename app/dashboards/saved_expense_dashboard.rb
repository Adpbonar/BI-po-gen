...
class SavedExpenseDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how saved expenses are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(saved_expense)
  #   "SavedExpense ##{saved_expense.id}"
  # end
end
