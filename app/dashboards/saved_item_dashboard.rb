...
class SavedItemDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how saved items are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(saved_item)
  #   "SavedItem ##{saved_item.id}"
  # end
end
