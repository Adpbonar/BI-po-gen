...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { percentage: @discount.percentage, service_item_id: @discount.service_item_id } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { percentage: @discount.percentage, service_item_id: @discount.service_item_id } }
