...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post rankings_url, params: { ranking: { name: @ranking.name, participant_id: @ranking.participant_id, ranking: @ranking.ranking } }
    end
  ...
  test "should update ranking" do
    patch ranking_url(@ranking), params: { ranking: { name: @ranking.name, participant_id: @ranking.participant_id, ranking: @ranking.ranking } }
